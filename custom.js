  ...
  cron.schedule('*/60 * * * *', () => {
    ...
    api.getThreadList(25, null, ['INBOX'], async (err, data) => {
      ...
      async function message(thread) {
        try {
          api.sendMessage({
            body: `⟩ Thank you for using 𝗔𝗘𝗦𝗧𝗛𝗘𝗥-𝗕𝗢𝗧!\n\n⟩ Fork Here: https://replit.com/@anjara0002\n\n⟩ For your concerns about the Repl, kindly add and follow me on FB: https://www.facebook.com/mitama.sama`
          }, thread.threadID, (err) => {
            if (err) return;
